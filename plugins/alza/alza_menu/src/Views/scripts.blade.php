...
<script type="text/javascript" src="{{ asset('vendor/azmenu/scripts.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/azmenu/scripts2.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/azmenu/menu.js') }}"></script>
