...
class Crudgen {
    ...
    public static function createRelationModels(array $arr){
        ...
        foreach($arr as $k => $r){
            if (isset($r['relRefTbl'])) {
                $out .= self::buildRelation($r['relType'],$r['relModel'],$r['relRefTbl'],$r['relForeign'],$r['relLocal']);
            }else{
                $out .= self::buildRelation($r['relType'],$r['relModel'],null,$r['relForeign'],$r['relLocal']);
            }
        }
        return $out;
    }
    ...
    public static function renderRelationFormCreate(array $arr)
    {
        $out = '';
        foreach($arr as $r){
            $out .= self::buildRelationHtmlCreate($r['relModel'],$r['relForeign'],$r['relLocal'],$r['relFieldShow']);
        }
        return $out;
    }
    ...
    public static function renderRelationFormEdit(array $arr, string $m)
    {
        $out = '';
        foreach($arr as $r){
            $out .= self::buildRelationHtmlEdit($r['relModel'],$r['relForeign'],$r['relLocal'],$r['relFieldShow'],$m);
        }
        return $out;
    }
