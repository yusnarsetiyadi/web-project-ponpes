...
class CrudController extends Controller
{
    public function insert(Request $request){
        ...
        $model = [
            ...
            '{{modelNameSpace}}' => config('alzacrud.namespace.model'),
        ...
        $pathslist = [
            [
                'target'=>str_replace('\\','/',config('alzacrud.path.model')),
                'source'=>str_replace('\\','/',config('alzacrud.path.stub')),
                'new'   =>ucwords($request->modelName).'.php',
                'stub'  =>$stubmodelfile
            ],[
                'target'=>str_replace('\\','/',config('alzacrud.path.migration')),
                'source'=>str_replace('\\','/',config('alzacrud.path.stub')),
                ...
                'target'=>str_replace('\\','/',config('alzacrud.path.controller').'Alza_admin/'),
                'source'=>str_replace('\\','/',config('alzacrud.path.stub')),
                ...
                'view' => [
                    [
                        'target'=>str_replace('\\','/',config('alzacrud.path.views').'alza_admin/alza_modul/').strtolower($request->modelName).'/',
                        'source'=>str_replace('\\','/',config('alzacrud.path.stub')),
                        'stub'=>'create.stub',
        ...
        if ($exec) {
            try {
                Crudgen::addRoute("Route::resource('/".strtolower($request->modelName)."s', Alza_admin\\".ucwords($request->modelName)."Controller::class);\n\t/*new route*/");
