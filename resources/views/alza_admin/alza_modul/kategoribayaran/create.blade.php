    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route(config('pathadmin.admin_prefix').'kategoribayarans.store') }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group"><label>nominal</label><input name="nominal" class="form-control"
                                    type="text" value="{{ old('nominal') }}"></div>
                        </div>
                        <div class="col-12">
