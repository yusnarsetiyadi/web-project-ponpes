                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group"><label>judul</label><input name="judul" class="form-control"
                                    type="text" value="{{$slider->judul}}"></div>
                        </div>
                        <div class="col-12">
                            <div class="form-group"><label>keterangan</label><input name="keterangan"
                                    class="form-control" type="text" value="{{$slider->keterangan}}"></div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="form-group"><label>aktif</label><select name="aktif" class="form-control">
                                    <option value="Y" {!! (($slider->aktif == 'Y') ? 'selected' : '') !!}>Y</option>
                                    <option value="N" {!! (($slider->aktif == 'N') ? 'selected' : '') !!}>N</option>
                                </select></div>
                        </div>
                        <div class="col-12 d-flex justify-content-end border-top">
                            ...
                            <a class="btn btn-light-secondary btn-sm mr-1 mb-1 mt-1"
                                href="{{ route(config('pathadmin.admin_prefix').'sliders.index') }}"> Batal</a>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
