    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route(config('pathadmin.admin_prefix').'sliders.store') }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                    @csrf
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group"><label>keterangan</label><input name="keterangan"
                                    class="form-control" type="text" value="{{ old('keterangan') }}"></div>
                        </div>
                        <div class="col-12">
