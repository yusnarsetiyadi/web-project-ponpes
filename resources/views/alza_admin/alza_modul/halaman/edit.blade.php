    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                ...
                @endif
                {!! Form::model($halaman, ['method' => 'PATCH', 'route' =>
                [config('pathadmin.admin_prefix').'halamans.update', $halaman->id],'enctype' => 'multipart/form-data'])
                !!}
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group"><label>gambar</label><input name="gambar" class="form-control"
                                    ...
                                    value="{{$halaman->gambar}}"></div>
                        </div>
                        <div class="col-12">
                            <div class="form-group"><label>aktif</label><select name="aktif" class="form-control">
                                    <option value="N" {!! (($halaman->aktif == 'N') ? 'selected' : '') !!}>N</option>
                                    <option value="Y" {!! (($halaman->aktif == 'Y') ? 'selected' : '') !!}>Y</option>
                                </select></div>
                        </div>
                        <div class="col-12 d-flex justify-content-end border-top">
                            ...
                            <a class="btn btn-light-secondary btn-sm mr-1 mb-1 mt-1"
                                href="{{ route(config('pathadmin.admin_prefix').'halamans.index') }}"> Batal</a>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
