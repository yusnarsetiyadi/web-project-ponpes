    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route(config('pathadmin.admin_prefix').'halamans.store') }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                    @csrf
                <div class="form-body">
                    <div class="row">

                        <div class="col-12">
                            <div class="form-group"><label>seo</label>
                                <input name="seo" class="form-control" type="text"
                                    value="{{ old('seo') }}">
                                <small class="text-danger">Jika kosong maka judul akan di jadikan seo secara otomatis</small>
                                </div>
                        </div>
                        <div class="col-12">
