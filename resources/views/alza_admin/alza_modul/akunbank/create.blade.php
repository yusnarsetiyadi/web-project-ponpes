        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route(config('pathadmin.admin_prefix').'akunbanks.store') }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                        @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>norek</label>
                                    <input name="norek" class="form-control" type="text" value="{{ old('norek') }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>atas_nama</label>
                                    <input name="atas_nama" class="form-control" type="text" value="{{ old('atas_nama') }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>nama_bank</label>
                                    <input name="nama_bank" class="form-control" type="text" value="{{ old('nama_bank') }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
